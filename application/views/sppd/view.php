...
<head>
    ...
    <title>View SPPD FORM ITU Portal | Dasboard</title>
    <!-- Favicon-->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../../index.html">ITU - PORTAL DASHBOARD</a>
            </div>
...
<li class="active">
                      ...
                      <ul class="ml-menu">
                          <li>
                              <a href="../../pages/sppd/create.html">Create SPPD Form</a>
                          </li>
                          <li>
                              <a href="../../pages/sppd/view.html">View SPPD Form</a>
                          </li>
...
<li>
                      ...
                      <ul class="ml-menu">
                          <li>
                              <a href="../../pages/cuti/create.html">Create CUTI Form</a>
                          </li>
                          <li>
                              <a href="../../pages/cuti/view.html">View CUTI Form</a>
                          </li>
