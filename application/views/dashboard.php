        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Users</div>
            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        <div class="icon">
                            <a href="<?php echo base_url(); ?>index.php/getemp">
                                <i class="material-icons">  local_atm</i>
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        <div class="icon">
                            <a href="<?php echo base_url(); ?>index.php/cutiemp">
                                <i class="material-icons">local_airport</i>
                        </div>
                        <div class="content">
