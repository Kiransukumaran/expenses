...
<script type="text/javascript">
 function userController($scope,$http) {
     $scope.users = [];
     $http.get('<?php echo base_url(); ?>index.php/ang').success(function($data){ $scope.users=$data; });
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    PT INDOTRUCK UTAMA SPPD FORM VIEW PORTAL
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                <table ng-controller="userController" class="table table-bordered table-striped table-hover dataTable js-exportable">
